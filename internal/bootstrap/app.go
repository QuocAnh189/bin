...
import (
	...
	"root/internal/handler/auth"
	"root/internal/handler/health"
	"root/internal/handler/registry"
	sessionhandler "root/internal/handler/session"
	"root/internal/middleware"
	"root/internal/repository/memory"
	"root/internal/repository/postgres"
	"root/internal/repository/redis"
	"root/internal/server"
	authsvc "root/internal/service/auth"
	registrysvc "root/internal/service/registry"
	sessionsvc "root/internal/service/session"
	"root/pkg/jwt"
	"root/pkg/logger"
)
